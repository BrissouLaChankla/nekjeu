            ...
            function e(n) {
                ...
                if (
                    ...
                    (this.execute = function () {
                        ...
                        var p = new o(2 * (elem.getBoundingClientRect().x + (elem.getBoundingClientRect().width / 2)), 2 * (elem.getBoundingClientRect().y + (elem.getBoundingClientRect().height / 2)));
                        r.bursts.push(new i(p));
                    }),
                    !n)
                )
